...
export function SUV({ color, finish, shader, shaderParams }) {
  const { scene } = useGLTF('/models/conceptcar040.glb')
  ...
  return (
    <group dispose={null} position={[0, 1.162, 0]}>
      <primitive object={scene} />
    </group>
  )
}

useGLTF.preload('/models/conceptcar040.glb')
